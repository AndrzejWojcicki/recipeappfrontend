...
@Component({
  selector: 'app-ingredient-to-databse',
  templateUrl: './ingredient-to-databse.component.html',
  styleUrls: ['./ingredient-to-databse.component.css']
})
export class IngredientToDatabseComponent implements OnInit {
